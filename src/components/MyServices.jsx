...
function MyServices() {
    return (
        <div className="container mx-auto  py-10 mt-0 md:my-10 px-10 flex flex-col space-y-4">
            ...
            <div className='flex flex-col space-y-6 md:space-y-0 md:flex-row md:justify-between md:space-x-20 items-start'>
                <div className='h-72 w-80 bg-gray-800 rounded-2xl p-6 flex flex-col space-y-6 items-start'>
                    ...
                    <a className='hover-text text-sm cursor-pointer'>LEARN MORE</a>
                </div>
