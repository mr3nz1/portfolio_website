...
function MyWork(props) {
    ...
    return (
        <div ref={refVal} className="h-screen container mx-auto  py-10 mt-0 md:my-10 px-10 flex flex-col space-y-10">
            <FadeIn>
            ...
            <div className='flex flex-col space-y-6 md:space-y-0 md:flex-row md:justify-between md:space-x-10 items-start'>
                <FadeIn>
                    <div className="bg-gray-800 w-full md:w-64 h-96 rounded-2xl relative project-container overflow-hidden">
